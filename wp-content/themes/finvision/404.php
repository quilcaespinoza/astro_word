...
$column_classes = finvision_get_columns_classes( true ); ?>
	<div id="content" class="<?php echo esc_attr( $column_classes['main_column_class'] ); ?> text-center">
        <div class="inline-block">
            <p class="not_found">
                <span><?php esc_html_e( '404', 'finvision' ); ?></span>
            </p>
            <h1><?php esc_html_e( 'Oops, page not found!', 'finvision' ); ?></h1>
            <p>
		        <?php esc_html_e( 'You can search what interested:', 'finvision' ); ?>
            </p>
            <div class="widget widget_search">
		        <?php get_search_form(); ?>
            </div>
            <p>
		        <?php esc_html_e( 'or', 'finvision' ); ?>
            </p>
            <p>
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="theme_button color1 min_width_button">
			        <?php esc_html_e( 'Go to homepage', 'finvision' ); ?>
                </a>
            </p>
        </div>
	</div><!--eof #content -->
