...
$columns_bottom_margin = '';

if ( empty( $extra_data['columns_padding'] ) ) {
    $columns_bottom_margin = 'columns_margin_bottom_20';
}

?>
<div class="form-wrapper <?php echo esc_attr( $extra_data['background_color'] . ' ' . $extra_data['columns_padding'] . ' ' . $extra_data['input_text_center'] . ' ' . $columns_bottom_margin ); ?>">
