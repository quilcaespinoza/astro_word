	...
	case 'background_icon':
		switch ( $teaser_accent_color ) {
			...
			case 'color4':
				...
				break;
			case 'color1 light_bg':
				$icon_class = 'highlight light_bg_color';
				break;
			case 'color2 light_bg':
				$icon_class = 'highlight2 light_bg_color';
				break;
			case 'color3 light_bg':
				$icon_class = 'highlight3 light_bg_color';
				break;
			case 'color4 light_bg':
				$icon_class = 'highlight3 light_bg_color';
				break;
			default:
	...
	case 'background_icon round':
		switch ( $teaser_accent_color ) {
			...
			case 'color4':
				...
				break;
			case 'color1 light_bg':
				$icon_class = 'highlight light_bg_color round';
				break;
			case 'color2 light_bg':
				$icon_class = 'highlight2 light_bg_color round';
				break;
			case 'color3 light_bg':
				$icon_class = 'highlight3 light_bg_color round';
				break;
			case 'color4 light_bg':
				$icon_class = 'highlight3 light_bg_color round';
				break;
	...
	case 'icon_image_bg': ?>
		...
		<div class="bg_teaser with_padding big-padding <?php echo esc_attr( $teaser_style ); ?>">
            ...
            <div class="teaser_content">
                ...
                <?php if ($atts['teaser_types'][ $teaser_type ]['button']['show_button'] && $button_options ) {
                    echo fw()->extensions->get('shortcodes')->get_shortcode('button')->render($button_options);
                }
                ?>
