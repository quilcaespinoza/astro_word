...
$color = 'color' . $atts['accent_color'];

?>
<ul class="price-table with_background bottom_color_border <?php echo esc_attr( $color ); ?> rounded overflow_hidden">
	...
	<?php if( ! empty( $atts['price']) ) : ?>
		<span class="big"><?php echo wp_kses_post( $atts['price'] ); ?></span><?php echo !empty( $atts['price_decimal'] ) ? '.' . wp_kses_post( $atts['price_decimal'] ) : ''; ?>
	<?php endif; ?>
    <?php if( ! empty( $atts['description']) ) : ?>
        <div class="price-description"><?php echo wp_kses_post( $atts['description'] ); ?></div>
    <?php endif; ?>
	</li>
