...
<div class="isotope_container isotope row <?php echo esc_attr( $margin_class ); ?> masonry-layout team-grid columns_padding_0 columns_margin_0"
    <?php if ( $atts['show_filters'] ) : ?>
        data-filters=".isotope_filters-<?php echo esc_attr( $unique_id ); ?>"
    <?php endif; // filters ?>
>
    <?php
    $item_layout = 'loop-item';
