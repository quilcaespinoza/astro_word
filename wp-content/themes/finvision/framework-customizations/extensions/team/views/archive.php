...
?>
	<div id="content" class="<?php echo esc_attr( $column_classes['main_column_class'] ); ?>">
		...
		<?php if ( have_posts() ) : ?>
			<div class="isotope_container isotope row masonry-layout team-grid columns_padding_0 columns_margin_0"
			...
			>
				...
				while ( have_posts() ) : the_post();
					...
					?>
					<div
						class="isotope-item col-xs-12 col-sm-6 <?php echo esc_attr( $sort_classes[get_the_ID()] ); ?>">
						<?php
		...
		<?php // Pagination.
			$pagination = paginate_links( array(
				'prev_text' => esc_html__( 'Prev', 'finvision' ),
				'next_text' => esc_html__( 'Next', 'finvision' ),
				'type'      => 'list',
			));
			if ($pagination) {
