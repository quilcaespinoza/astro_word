...
$all_src_cover = ' ' . $data['settings']['extra']['slider_responsive_layout']['all_scr_cover'];
$height_by_image = ( !empty( $all_src_cover ) ) ? ' ' . $data['settings']['extra']['slider_responsive_layout']['all-scr-cover']['slider_height'] : '';
$skew_overlay = $data['settings']['extra']['skew_overlay'] ? ' with_skew_overlay' : '';
$slider_custom_class = ' ' . $data['settings']['extra']['slider_custom_class'];
...
if ( isset( $data['slides'] ) ): ?>
	<section class="intro_section <?php echo esc_attr( $page_mainslider . ' ' . $slider_background . $all_src_cover . $height_by_image . $skew_overlay . $slider_custom_class ); ?>">
        <?php if ( $data['settings']['extra']['skew_overlay'] ) : ?>
			...
			<ul class="slides">
				...
				<li class="<?php echo esc_attr( $slide_align ); ?>">
                    ...
                    if ( !empty( $slide_media_layers_before ) ) :
                        ...
                        ?>
                        <div class="slide-image-wrap <?php if ( $layer['media_layer_animation'] ) { echo 'to_animate '; } echo esc_attr( $layer['media_layer_class'] ); ?>" data-animation="<?php echo esc_attr( $layer['media_layer_animation'] ); ?>">
	                        <?php
									...
									<?php if ( $slide_layers || $slide_buttons ) : ?>
                                        <div class="slide_description">
                                            ...
                                            <?php foreach ( $slide_layers as $layer ): ?>
                                                <div class="intro-layer to_animate" data-animation="<?php echo esc_attr( $layer['layer_animation'] ); ?>">
                                            ...
                                            <?php if ( !empty( $slide_buttons ) ) : ?>
                                                <div class="intro-layer to_animate" data-animation="<?php echo esc_attr( $slide_button_animation ); ?>">
