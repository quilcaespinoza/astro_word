 ...
 * Theme Includes
 */
class Finvision_Theme_Includes {
	...
	public static function init() {
		...
		//theme path
		self::$template_directory = FINVISION_THEME_PATH;

		self::$template_directory_uri = FINVISION_THEME_URI;
...
//		self::$include_isolated_callable = create_function( '$path', 'include $path;' );
	...
	public static function get_parent_path( $rel_path ) {
		return FINVISION_THEME_PATH . self::get_rel_path( $rel_path );
	}
