...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('cubeportfolio/css/cubeportfolio.min.css')}}">     
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-transparent bg-faded nav-sticky" id="menu">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.html">
                <h4 class='logo logo-dark'>ProgrammingJE</h4>
                <h4 class='logo logo-light hidden-md-down' style="color: white;">ProgrammingJE</h4>
            </a>
            <div  id="navbarNavDropdown" class="navbar-collapse collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown active">
                        <a class="nav-link url" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#rev_slider_1078_1_wrapper">Inicio</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link url" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#servicios">Servicios</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link url" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#quienes-somos">¿Quienes Somos?</a>
                    </li>
                    <li class="nav-item dropdown dropdown-full-width">
                        <a class="nav-link url" data-toggle="dropdown" href="#contactenos" role="button" aria-haspopup="true" aria-expanded="false"> Contactenos</a>
                    </li>
                </ul>        
            </div>
        </div>
            ...
            <ul>    
                ...
                <li data-index="rs-3045" data-transition="parallaxtoleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption mainSlide-Subtitle   tp-resizeme" 
                         ...
                         style="z-index: 7; white-space: nowrap;text-transform:left;">Lleva tu proyecto a un nuevo nivel</div>
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption mainSlide-Title-Centered   tp-resizeme" 
                         ...
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 6; text-align:left; max-width:1170px; white-space: normal;">Servicio de Sistemas informáticos</div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption mainSlide-Button btn btn-lg btn-white-outline " 
                         ...
                         style="z-index: 8; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">LEE MÁS </div>
                </li>
                <!-- SLIDE  -->
                <li data-index="rs-3046" data-transition="parallaxtoleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption mainSlide-Title-Centered   tp-resizeme" 
                         ...
                         style="z-index: 6; text-align:center; white-space: normal;">Construimos Usando Herramientas Modernas</div>
                    <!-- LAYER NR. 3 -->
                ...
                <li data-index="rs-3047" data-transition="parallaxtoright" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-saveperformance="off"  data-title="HTML5 Video" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="images/Busy-People.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="rs-background-video-layer" 
                         ...
                         data-videomp4="images/Busy-People.jpg" 
                    ...
                    <div class="tp-caption mainSlide-Title-Centered   tp-resizeme" 
                         ...
                         style="z-index: 6; text-align:center; white-space: normal;">Administra tu propio negocio</div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption mainSlide-caption   tp-resizeme" 
                         ...
                         data-paddingbottom="[10,10,10,10]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 6; text-align:left; max-width:1170px; white-space: normal;">Agiliza tus procesos y obtén un mejor rendimiento </div>
                </li>
            </ul>
            <div class="tp-bannertimer" style="height: 7px; background-color: rgba(255, 255, 255, 0.25);"></div>    </div>
    </div><!-- END REVOLUTION SLIDER -->
    <div class="container pt90" id="servicios">
        <div class="title-heading1 mb40">
            <h3>beneficios de nuestros sistemas</h3>
        </div>
        <div class="row pb60">
            <div class="col-lg-4 mb30 wow zoomInUp" data-wow-delay="100ms" data-wow-duration=".4s">
                <div class="icon-box icon-box-center">
                    <i class="icon-hover-1 bg-primary fa fa-bar-chart icon-hover-default"></i>
                    <h4>REDUCE EL COSTO DE TUS GASTOS EN UN 85%</h4>
                </div>
            </div><!--/col-->
            <div class="col-lg-4 mb30 wow zoomInDown" data-wow-delay="200ms" data-wow-duration=".6s">
                <div class="icon-box icon-box-center">
                    <i class="icon-hover-1 bg-primary fa fa-check icon-hover-default"></i>
                    <h4>REDUCE ERRORES DE PROCESOS</h4>
                </div>
            </div><!--/col-->
            <div class="col-lg-4 mb30 wow zoomInRight" data-wow-delay="300ms" data-wow-duration=".8s">
                <div class="icon-box icon-box-center">
                    <i class="icon-hover-1 bg-primary fa fa-lock icon-hover-default"></i>
                    <h4>SEGURIDAD Y RAPIDEZ</h4>
                </div>
            </div><!--/col-->
            <div class="col-lg-4 mb30 wow zoomInRight" data-wow-delay="300ms" data-wow-duration=".8s">
                <div class="icon-box icon-box-center">
                    <i class="icon-hover-1 bg-primary  fa fa-clipboard icon-hover-default"></i>
                    <h4>SIMPLIFICA LOS PROCEDIMIENTOS ADMINISTRATIVOS</h4>
                </div>
            </div><!--/col-->
            <div class="col-lg-4 mb30 wow zoomInRight" data-wow-delay="300ms" data-wow-duration=".8s">
                <div class="icon-box icon-box-center">
                    <i class="icon-hover-1 bg-primary icon-refresh icon-hover-default"></i>
                    <h4>SEGURIDAD Y REAPIDEZ</h4>
                </div>
            </div><!--/col-->
            <div class="col-lg-4 mb30 wow zoomInRight" data-wow-delay="300ms" data-wow-duration=".8s">
                <div class="icon-box icon-box-center">
        ...
        <div class="container pt90 pb60">
            <div class="row align-items-center">
                <div class="col-lg-6 mb30">
                    <h3 class="text-white mb30">Análisis Empresarial</h3>
                    <p class="text-white-gray">
                        Aplicamos metodologias para poder evaluar y hacer un diagnostico de los puntos fuertes y debiles de la empresa, asi poder desarrollar una estrategia que permita logar los objetivos establecidos.
                    </p>
                </div>
                <div class="col-lg-3 mb30 text-center">
                    ...
                    <h4 class="pt30 text-white">Inicio creativo</h4>
                </div>
                <div class="col-lg-3 mb30 mb30 text-center">
                    ...
                    <h4 class="pt30 text-white">Soluciones One Click</h4>
                </div>
            </div>
        </div>
    </div><!--/.Analysis-->
    <div class="container pt90 pb60">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 ml-auto mb30">
                <h3 class="mb20">Planificación Estratégica</h3>
                <p>
                    Trabajamos con gente talentosa, líderes en sus propios campos que funcionan como un equipo para obtener resultados hechos a medida.
                    Nos enfocamos en que obtenga los mejores resultados y satisfacciones con nuestros servicios.
                </p>
                <p>
                    El análisis consta de una implementación de metodología para evaluar los puntos débiles y comenzar con las propuestas de posibles soluciones, avanzamos con la segunda etapa que sería el proceso con un nuevo plan de trabajo, algo mas fresco y actualizado.
                </p>
            </div>
        </div>
    </div><!--/.Strategy Planning-->
    <div class="title-heading1 mb40 pt90" id="quienes-somos">
                    ...
                    <div class=" testimonial testimonial-dark">
                        <div class="row align-items-center">
                            <div class="col-lg-3 ml-md-5">
                                <img src="images/usuario.png" alt="" class="img-fluid circle">
                            </div>
                            <div class="col-lg-7">
                                <p class="lead">
                                ...
                                <h5>Eduardo Pacompia Lopez - <span>Gerente General</span></h5>
                            </div>
                        </div>
                    </div>
                </div><!--item-->
                <div class="item">
                    <div class=" testimonial testimonial-dark">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <p class="lead">
                                    " Trabajar es lo que nos mantiene vivos, sin nuestro trabajo, no seríamos más que seres sin metas en la vida "
                                </p>
                                <h5>José Quilca Espinoza - <span>Sub Gerente</span></h5>
                            </div>
                        </div>
                    </div>
                </div><!--item-->
                <div class="item">
                    <div class=" testimonial testimonial-dark">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <p class="lead">
                                    " Pensando en nuestra familia y en nuestros amigos, encontraremos la motivación necesaria para empezar un nuevo día de trabajo "
                                </p>
                                <h5>Cesar Cajavilca Olivares - <span>Analista</span></h5>
                            </div>
                        </div>
                    </div>
                </div><!--item-->
                    ...
                    <div class=" testimonial testimonial-dark">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                ...
                                <h5>Ernesto Dias Samame - <span>Analista</span></h5>
                            </div>
                        </div>
                    </div>
                </div><!--item-->
                    ...
                    <div class=" testimonial testimonial-dark">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                ...
                                <h5>Christian Obregon Olortegui - <span>Analista</span></h5>
                            </div>
                        </div>
                    </div>
                </div><!--item-->
    ...
    <footer class="footer footer-dark pt50 pb30" id="contactenos">
        <div class="container">
            <div class="row">
                <div class="col-lg-6  ml-auto mr-auto text-center clearfix">
                    ...
                    <h4><i class="fa fa-phone"></i> 960-692-526</h4>
                    <h4><i class="fa fa-envelope"></i> quilca.espinoza@gmail.com</h4>
                    <h4><i class="fa fa-phone"></i> 953-553-770</h4>
                    <h4><i class="fa fa-envelope"></i> eduardopacompialopez@gmail.com</h4>
                    <h4><i class="fa fa-envelope"></i> programmingje@gmail.com</h4>
                    <p>© 2018 ProgrammingJE. Todos los derechos reservados.</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script type="text/javascript">
        function calculateScroll() {
            ...
            var rangeTop = 450;
            var rangeBottom = 100;
            $('#menu li.nav-item').find('a.nav-link.url').each(function() {
                contentTop.push($($(this).attr('href')).offset().top);
                contentBottom.push($($(this).attr('href')).offset().top + $($(this).attr('href')).height());
            });
            $.each(contentTop, function(i) {
                if (winTop > contentTop[i] - rangeTop && winTop < contentBottom[i] - rangeBottom) {
                    $('#menu li.nav-item').removeClass('active').eq(i).addClass('active');
                }
            })
        };
