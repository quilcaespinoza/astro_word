google.maps.event.addDomListener(window,"load",function(){
	...
	var autocomplete1 = document.getElementById("partida");
	var autocomplete2 = document.getElementById("destino");
	...
	search2.addListener('place_changed',function(){
			...
			var origen = document.getElementById("partida").value;
			if(origen != ""){
				//alert(origen);
		 ...
		 function buscarDireccion(lat,lon,marker){
	    	...
	    	geocoder.geocode({'location':ubicacion},function(results,status){
	    		if(status === google.maps.GeocoderStatus.OK){
	    			...
	    			var caja = document.getElementById("partida");
