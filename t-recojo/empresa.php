	...
	<div class="servicios">
		...
		<div class="content-service">
			<div class="img-servicio">
				<img src="imagenes/toyota_2018.jpg" alt="">
			</div>
		...
		<div class="content-service">
			<div class="img-servicio">
				<img src="imagenes/kia_sorento.jpg" alt="">
			</div>	
			<div class="descripcion-servicio">
	...
	<div class="descripcion">
		...
		<div class="descripcion-tipos">
			<div class="descripcion-items">
				...
				<p>Puedes solicitar tus servicios a través de esta página web, whatsapp o correo electrónico.</p>
			...
			<div class="descripcion-items">
				...
				<p>Oh no! olvido llevar algo?, tranquilo nosotros nos encargamos de eso, con la seguridad y confianza que usted necesita.</p>
				<div class="img-descripcion-tipo">
